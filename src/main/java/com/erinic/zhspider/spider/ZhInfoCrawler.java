 ...
 */
@Component
public class ZhInfoCrawler implements Crawler{

    @Qualifier("ZhInfoDaoPipeline")
    @Autowired
    private ZhInfoDaoPipeline zhInfoDaoPipeline;

    private final static String START_URL = "https://www.zhihu.com/topic/19551556/top-answers";
    ...
    public void crawl() {
        OOSpider.create(Site.me()
                ...
                .setRetryTimes(5)
                .setSleepTime(500)
                .setTimeOut(3 * 60 * 1000),zhInfoDaoPipeline, ZhInfo.class)
                .addUrl(START_URL)
                .thread(5)
                .run();
    }
    ...
    public static void main(String[] args) {
        applicationContext.getBean(ZhInfoCrawler.class).crawl();
    }
}
